            ...
            <div class="question-list">
                ...
                <div id="duration" data-duration="<?= $quiz['duration'] ?>">
                    ...
                    <ul class="option">
                        ...
                        <li>
                            <input type="radio" name="answer" id="option1" value="<?= $point->A ?>" class="my-radio count-down">
                            <label for="option1">(A) <?= $options->A ?></label>
                        </li>
                        <li>
                            <input type="radio" name="answer" id="option2" value="<?= $point->B ?>" class="my-radio count-down">
                            <label for="option2">(B) <?= $options->B ?></label>
                        </li>
                        <li>
                            <input type="radio" name="answer" id="option3" value="<?= $point->C ?>" class="my-radio count-down">
                            <label for="option3">(C) <?= $options->C ?></label>
                        </li>
                        <li>
                            <input type="radio" name="answer" id="option4" value="<?= $point->D ?>" class="my-radio count-down">
                            <label for="option4">(D) <?= $options->D ?></label>
                        </li>
                    </ul>
                </div>
