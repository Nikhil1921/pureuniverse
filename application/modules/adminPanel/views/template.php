	...
	<head>
		...
		<body>
							...
							<nav class="pcoded-navbar">
								<div class="pcoded-inner-navbar main-menu">
									...
									<ul class="pcoded-item pcoded-left-item">
										...
										<li class="<?= ($name == 'student') ? 'active' : '' ?>">
											<?= anchor(admin('student'), '<span class="pcoded-micon"><i class="fa fa-users"></i></span><span class="pcoded-mtext">Students</span>') ?>
										</li>
										<li class="<?= ($name == 'category') ? 'active' : '' ?>">
											<?= anchor(admin('category'), '<span class="pcoded-micon"><i class="fa fa-file-text-o"></i></span><span class="pcoded-mtext">Category</span>') ?>
										</li>
										<li class="<?= ($name == 'language') ? 'active' : '' ?>">
											<?= anchor(admin('language'), '<span class="pcoded-micon"><i class="fa fa-language"></i></span><span class="pcoded-mtext">Language</span>') ?>
										</li>
										<li class="<?= ($name == 'examTable') ? 'active' : '' ?>">
											<?= anchor(admin('examTable'), '<span class="pcoded-micon"><i class="fa fa-table"></i></span><span class="pcoded-mtext">Exam Table</span>') ?>
										</li>
										<li class="<?= ($name == 'exam') ? 'active' : '' ?>">
											<?= anchor(admin('exam'), '<span class="pcoded-micon"><i class="fa fa-file-text-o"></i></span><span class="pcoded-mtext">Exam</span>') ?>
										</li>
										<li class="<?= ($name == 'faq') ? 'active' : '' ?>">
											<?= anchor(admin('faq'), '<span class="pcoded-micon"><i class="fa fa-question-circle-o"></i></span><span class="pcoded-mtext">FAQ</span>') ?>
										</li>
										<li class="<?= ($name == 'career') ? 'active' : '' ?>">
											<?= anchor(admin('career'), '<span class="pcoded-micon"><i class="fa fa-users"></i></span><span class="pcoded-mtext">Careers</span>') ?>
										</li>
										<li class="<?= ($name == 'franchise') ? 'active' : '' ?>">
											<?= anchor(admin('franchise'), '<span class="pcoded-micon"><i class="fa fa-file-text-o"></i></span><span class="pcoded-mtext">Franchise</span>') ?>
										</li>
										<li class="<?= ($name == 'voucher') ? 'active' : '' ?>">
											<?= anchor(admin('voucher'), '<span class="pcoded-micon"><i class="fa fa-ticket"></i></span><span class="pcoded-mtext">Vouchers</span>') ?>
										</li>
									</ul>
								</div>
							</nav>
			...
			<div id="common-modal" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
				<div class="modal-dialog modal-<?= $name == 'exam' ? 'xl' : 'lg' ?>" role="document">
